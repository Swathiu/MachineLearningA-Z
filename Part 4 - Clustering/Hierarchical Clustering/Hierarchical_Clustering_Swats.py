...
#Ward method minimizes the within cluster variance
#Linkage = Algorithm for creating clusters
...
#Tells for each customer which cluster the people belong to
y_hc = hc.fit_predict(X)

#Visualizing the clusters
#Plotting clusters in 2-dimensions
