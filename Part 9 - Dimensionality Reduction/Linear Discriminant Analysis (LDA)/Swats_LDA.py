...
#Feature Scaling must be applied when we use PCA or LDA
from sklearn.preprocessing import StandardScaler
sc_X = StandardScaler()
X_train = sc_X.fit_transform(X_train)
X_test = sc_X.transform(X_test)

#We apply LDA right after data preprocessing
#Applying LDA
from sklearn.discriminant_analysis import LinearDiscriminantAnalysis as LDA
#n_components - No. of extracted features that you need that will explain most variance
#2 Linear DIscriminant/extracted independent variables that separate the most the classes of dependent variable
